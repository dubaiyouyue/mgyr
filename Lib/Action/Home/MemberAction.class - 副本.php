...
class MemberAction extends BaseAction{
    ...
    public function score(){
        ...
        $getjifen= M('jifenjilu','gz_',otherdbs())->where(array('id'=>$login))->limit(10)->order('id desc')->select(); 
    ...
    public function mycollection(){
        $login=$this->is_login();
        $mycollection=$this->collectionpc->where(array('uid'=>$login))->order('id desc')->select();
